...
public class exercicioum {
	...
	public static void main(String[] args) {
		...
		int escolha,loop, test;
		
		//test = 5; // para facilitar seu trabalho de testar professor. :)
		
		int vetorMain[] = new int[5];
	...
	//consultar qual o maior valor armazenado no vetor e indicar qual o elemento que contém esse valor
		...
		System.out.printf("Maior número é %d, no índice %d", maior, flag);
	...
	public static void Operacao7(int vetor7[]) {
		...
		System.out.printf("menor número é %d, no índice %d", menor, flag);
